...
class SourcesResults(BaseDialog):
	def __init__(self, *args, **kwargs):
		...
		self.info_icons_dict = {'easynews': get_icon('easynews'), 'real-debrid': get_icon('realdebrid'), 'premiumize': get_icon('premiumize'),
							'offcloud': get_icon('offcloud'), 'torbox': get_icon('torbox'), 'rd_cloud': get_icon('realdebrid'), 'pm_cloud': get_icon('premiumize'),
							'oc_cloud': get_icon('offcloud'), 'tb_cloud': get_icon('torbox')}
