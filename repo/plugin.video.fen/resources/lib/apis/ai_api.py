...
from modules.settings import ai_model_order, ai_model_limit, max_threads, tmdb_api_key
...
def ai_similar(media_info, dummy=None):
	...
	meta = meta_function('tmdb_id', tmdb_id, tmdb_api_key(), get_datetime(), get_current_timestamp())
