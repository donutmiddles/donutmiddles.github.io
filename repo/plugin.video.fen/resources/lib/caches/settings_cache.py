...
from caches.base_cache import connect_database, database_locations, locations
...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('fen.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('fen.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('fen.%s' % setting_id)
...
def set_many(settings_list):
	from caches.data_sync_cache import export_single
	for item in settings_list: set_setting(*item)
	export_single('settings_db')
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('fen.%s' % setting)])

def set_string(params):
	current_value = get_setting('fen.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('fen.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('fen.%s' % setting_id)
...
def default_context_menu(params):
	set_default(['context_menu.enabled', 'context_menu.order'])

def default_extras_list(params):
	from windows.base_window import ExtrasUtils
	set_default(['extras.order', 'extras.enabled', 'extras.order_name', 'extras.enabled_name'])
	ExtrasUtils().run()
...
def default_setting_values(setting_id):
	if 'fen.' in setting_id: setting_id = setting_id.replace('fen.', '')
...
#==================== DataSync
{'setting_id': 'datasync.location', 'setting_type': 'path', 'setting_default': 'empty_setting', 'browse_mode': '0'},
{'setting_id': 'datasync.sync_databases', 'setting_type': 'string',
'setting_default': 'navigator_db,watched_db,favorites_db,settings_db,discover_db,episode_groups_db,personal_lists_db'},
{'setting_id': 'datasync.autosync', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'datasync.autosync_timer', 'setting_type': 'action', 'setting_default': '30', 'min_value': '1', 'max_value': '120'},
#==================== Window Theme
...
#================================================================================#
#==================== Extras
{'setting_id': 'extras.enabled', 'setting_type': 'string', 'setting_default': kodi_utils.extras_order_default()},
{'setting_id': 'extras.order', 'setting_type': 'string', 'setting_default': kodi_utils.extras_order_default()},
...
#======================================HIDDEN=============================================#
#=========================================================================================#
{'setting_id': 'extras.enabled_name', 'setting_type': 'string', 'setting_default': kodi_utils.extras_display_default()},
{'setting_id': 'extras.order_name', 'setting_type': 'string', 'setting_default': kodi_utils.extras_display_default()},
...
{'setting_id': 'datasync.navigator_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.watched_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.favorites_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.settings_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.discover_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.episode_groups_db', 'setting_type': 'string', 'setting_default': '00000000'},
{'setting_id': 'datasync.personal_lists_db', 'setting_type': 'string', 'setting_default': '00000000'}
	]
